...
func run() error {
	...
	fl.Info("config loaded",
		...
		"lyrics.fetch_command", cfg.Lyrics.FetchCommand,
		"lyrics.fetch_timeout_seconds", cfg.Lyrics.FetchTimeoutSeconds,
	...
	app := ui.NewWithOptions(eng, sc, t, logger, ui.Options{
		...
		LyricsAutoFetch:            cfg.Lyrics.AutoFetch,
		LyricsSources:              cfg.Lyrics.Sources,
		LyricsSaveDir:              cfg.Lyrics.SaveDir,
		LyricsFetchCommand:         cfg.Lyrics.FetchCommand,
		LyricsFetchTimeoutSeconds:  cfg.Lyrics.FetchTimeoutSeconds,
